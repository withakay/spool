# Projector Project Overview

A minimal CLI tool that helps developers set up Projector file structures and keep AI instructions updated. The AI tools themselves handle all the change management complexity by working directly with markdown files.
...
├── core/       # Core Projector logic (templates, structure)
...
- Follow Projector's own change-driven development process