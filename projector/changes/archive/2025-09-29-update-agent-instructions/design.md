...
- **`projector list` prominence** - Essential for discovering changes and specs
...
- **Deprecation cleanup** - Remove noun-first patterns (projector change show)
...
- Use `projector list --specs` to discover current capabilities
