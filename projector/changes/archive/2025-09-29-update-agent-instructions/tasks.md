...
## 1. Restructure Projector README.md
...
- [x] 3.1 Document `projector list` and `projector list --specs` commands
- [x] 3.2 Document `projector show` with all flags and interactive mode
- [x] 3.3 Document `projector diff [change]` for viewing spec differences
- [x] 3.4 Document `projector archive` with --skip-specs option
- [x] 3.5 Document `projector validate` with --strict and batch modes
- [x] 3.6 Document `projector init` and `projector update` commands
...
- [x] 8.2 Run `projector init` to verify CLAUDE.md generation
