...
## Why
The Projector project needs a proper TypeScript foundation to build the minimal CLI that helps developers set up Projector file structures and keep AI instructions updated.
