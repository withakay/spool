...
- Search existing work: `projector spec list --long`, `projector list`
...
- Validate with `projector validate [change-id] --strict`
...
- **AND** summarize which assistant files were created versus refreshed (e.g., `CLAUDE.md (created)`, `.cursor/commands/projector-apply.md (refreshed)`)
