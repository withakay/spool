...
- [x] Change FILE_PATHS in `src/core/configurators/slash/cline.ts` from `.clinerules/projector-*.md` to `.clinerules/workflows/projector-*.md`
...
- [x] Verify the change follows Projector conventions
