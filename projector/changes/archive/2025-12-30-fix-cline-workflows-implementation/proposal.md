...
- **BREAKING**: Existing Cline users will need to re-run `projector init` to get the corrected workflow files
...
- Modified files: `.clinerules/workflows/projector-*.md` (moved from `.clinerules/projector-*.md`)
