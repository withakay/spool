...
- **THEN** the agent reads delta specs from `projector/changes/<name>/specs/`
- **AND** reads corresponding main specs from `projector/specs/`
...
- **THEN** create new main spec file at `projector/specs/<capability>/spec.md`
