# Adopt Future State Storage for Projector Changes
...
- Add new `projector-conventions` capability to document these conventions



## Impact

- Affected specs: New `projector-conventions` capability
- Affected code: 
  - projector/README.md (lines 85-108)
  - docs/PRD.md (lines 376-382, 778-783)
  - docs/projector-walkthrough.md (lines 58-62, 112-126)
  - projector/changes/add-init-command/ (migration needed)
