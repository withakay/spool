## Why
Add support for Crush AI assistant in Projector to enable developers to use Crush's enhanced capabilities for spec-driven development workflows.
...
- New files: .crush/commands/projector/ (proposal.md, apply.md, archive.md)