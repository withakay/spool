...
- [x] 1.2 Ensure `projector templates --schema <name>` returns artifact list for any schema
...
- [x] 2.3 Pass selected schema to `projector new change --schema <name>`
...
- [x] 3.2 Read artifact list dynamically from `projector status --json`
