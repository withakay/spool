...
- **WHEN** `projector/AGENTS.md` is regenerated or updated
...
`projector/AGENTS.md` SHALL include complete copy/paste templates and inline examples exactly where agents make corresponding edits.
...
`projector/AGENTS.md` SHALL offer a concise pre-validation checklist that highlights common formatting mistakes before running `projector validate`.
...
- **WHEN** reorganizing `projector/AGENTS.md`
