...
This module will coexist with the current Projector system as a parallel capability, potentially enabling future migration or integration.
...
- Replacing existing Projector functionality
...
**Resolution order:**
1. `${XDG_DATA_HOME:-~/.local/share}/projector/schemas/<name>.yaml` - Global user override
...
- Global user override: `${XDG_DATA_HOME:-~/.local/share}/projector/schemas/<name>.yaml`
