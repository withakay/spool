...
- [x] Verify bash completions work manually: `projector completion install bash && exec bash`
...
- [x] Verify fish completions work manually: `projector completion install fish`
...
- [x] Run `projector validate extend-shell-completions --strict` and resolve all issues
- [x] Update error messages to list all four supported shells
- [x] Verify `projector completion --help` documentation is current
