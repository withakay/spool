...
2. **Platform-Specific Wrappers**
   - Codex: CLI script (`.codex/spool-skills-codex`)
...
Extract common functionality from `.codex/spool-skills-codex` into shared module:
...
├── .codex/
│   ├── spool-skills-codex        # UPDATED: Use skills-core
...
1. Create `lib/skills-core.js`
   - Extract frontmatter parsing from `.codex/spool-skills-codex`
...
2. Update `.codex/spool-skills-codex` to use shared core
