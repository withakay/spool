...
- Reference: `.codex/spool-skills-codex` (lines 40-74)
...
- Reference: `.codex/spool-skills-codex` (lines 97-136)
...
**Files:**
- Modify: `lib/skills-core.js`
- Reference: `.codex/spool-skills-codex` (lines 212-280)
...
**Files:**
- Modify: `lib/skills-core.js`
- Reference: `.codex/spool-skills-codex` (lines 16-38)
...
**Files:**
- Modify: `.codex/spool-skills-codex` (add import at top)
...
Run: `node -c .codex/spool-skills-codex`
Expected: No output

**Step 3: Commit**

```bash
git add .codex/spool-skills-codex
...
**Files:**
- Modify: `.codex/spool-skills-codex` (lines 40-74)
...
Run: `.codex/spool-skills-codex find-skills | head -20`
...
**Files:**
- Modify: `.codex/spool-skills-codex` (lines 97-136, approximately)
...
**Files:**
- Modify: `.codex/spool-skills-codex` (lines 16-38, approximately)
...
Run: `.codex/spool-skills-codex bootstrap | head -50`
...
Run: `.codex/spool-skills-codex use-skill superpowers:brainstorming | head -20`
Expected: Shows brainstorming skill content

**Step 3: Test bootstrap command**

Run: `.codex/spool-skills-codex bootstrap | head -30`
...
- Files modified: `.codex/spool-skills-codex`, `README.md`, `RELEASE-NOTES.md`
...
- [ ] `.codex/spool-skills-codex` refactored to use shared core
