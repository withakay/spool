...
mkdir -p "$HOME/.config/opencode/spool-skills"
cp -r "$REPO_ROOT/lib" "$HOME/.config/opencode/spool-skills/"
cp -r "$REPO_ROOT/skills" "$HOME/.config/opencode/spool-skills/"

# Copy plugin directory
mkdir -p "$HOME/.config/opencode/spool-skills/.opencode/plugins"
cp "$REPO_ROOT/.opencode/plugins/spool-skills.js" "$HOME/.config/opencode/spool-skills/.opencode/plugins/"

# Register plugin via symlink
mkdir -p "$HOME/.config/opencode/plugins"
ln -sf "$HOME/.config/opencode/spool-skills/.opencode/plugins/spool-skills.js" \
       "$HOME/.config/opencode/plugins/spool-skills.js"
...
echo "Plugin installed to: $HOME/.config/opencode/spool-skills/.opencode/plugins/spool-skills.js"
echo "Plugin registered at: $HOME/.config/opencode/plugins/spool-skills.js"
