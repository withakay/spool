...
- Added unified `spool-skills-codex` script with bootstrap/use-skill/find-skills commands
- Cross-platform Node.js implementation (works on Windows, macOS, Linux)
- Namespaced skills: `spoolskills:skill-name` for spoolskills, `skill-name` for personal
...
- Updated terminology: "spool-skills" instead of "Core skills"

### Files Added
- `.codex/INSTALL.md` - Installation guide for Codex users
- `.codex/spool-skills-bootstrap.md` - Bootstrap instructions with Codex adaptations
- `.codex/spool-skills-codex` - Unified Node.js executable with all functionality

**Note:** Codex support is experimental. The integration provides core spool-skills functionality but may require refinement based on user feedback.
