...
(Add any project-specific assistant guidance here. Prefer `.spool/user-guidance.md` for instructions you want applied consistently to Spool change workflows.)
