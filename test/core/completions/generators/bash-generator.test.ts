...
describe('BashGenerator', () => {
  ...
  describe('generate', () => {
    it('should generate valid bash completion script with header', () => {
      ...
      expect(script).toContain('# Bash completion script for Projector CLI');
      expect(script).toContain('_projector_completion() {');
    ...
    it('should generate script that ends with complete registration', () => {
      ...
      expect(script.trim().endsWith('complete -F _projector_completion projector')).toBe(true);
    });
    ...
    it('should handle empty command list', () => {
      ...
      expect(script).toContain('_projector_completion() {');
      expect(script).toContain('complete -F _projector_completion projector');
    });
