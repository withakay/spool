...
Add support for Crush AI assistant in Spool to enable developers to use Crush's enhanced capabilities for spec-driven development workflows.
...
- New files: .crush/commands/spool/ (proposal.md, apply.md, archive.md)
