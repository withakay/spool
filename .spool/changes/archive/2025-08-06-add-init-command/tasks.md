...
- \[x\] 2.1 Create src/core/templates/readme-template.ts with Spool README content
...
- \[x\] 4.3 Add validation for existing Spool directories with helpful error message
