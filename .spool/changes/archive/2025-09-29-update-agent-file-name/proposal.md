...
The agent instructions live in `spool/README.md`, which clashes with conventional project README usage and creates confusion for tooling and contributors.

## Solution

Rename the agent instruction file to `spool/AGENTS.md` and update Spool tooling to use the new filename:

- `spool init` generates `AGENTS.md` instead of `README.md`
...
- `spool init` creates `spool/AGENTS.md`
- `spool update` refreshes `AGENTS.md`
- All specs reference `spool/AGENTS.md`
