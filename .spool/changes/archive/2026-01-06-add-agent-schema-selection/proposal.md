...
- Update `spool-new-change` skill to prompt user for schema selection
- Update `spool-continue-change` skill to work with any schema's artifacts
- Update `spool-apply-change` skill to handle schema-specific task structures
