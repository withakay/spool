...
- **`spool list` prominence** - Essential for discovering changes and specs
...
- **Deprecation cleanup** - Remove noun-first patterns (spool change show)
...
- Use `spool list --specs` to discover current capabilities
