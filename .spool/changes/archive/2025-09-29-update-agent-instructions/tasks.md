...
- \[x\] 3.1 Document `spool list` and `spool list --specs` commands
- \[x\] 3.2 Document `spool show` with all flags and interactive mode
- \[x\] 3.3 Document `spool diff [change]` for viewing spec differences
- \[x\] 3.4 Document `spool archive` with --skip-specs option
- \[x\] 3.5 Document `spool validate` with --strict and batch modes
- \[x\] 3.6 Document `spool init` and `spool update` commands
...
- \[x\] 8.2 Run `spool init` to verify CLAUDE.md generation
