...
Currently, delta specs are only applied to main specs when running `spool archive`. This bundles two concerns:
...
- Track `specsSynced: true` in `.spool.yaml` (rejected: unnecessary complexity)
