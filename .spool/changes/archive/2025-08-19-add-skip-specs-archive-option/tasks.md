...
1. **Flag Naming Convention**: Chose `--skip-specs` for clarity and consistency:
...
1. **Console Messaging Strategy**: Added explicit messages for all spec-skipping scenarios:
...
1. **Test Coverage Approach**: Created separate test cases for:
