...
```
spool status --change <id>
spool next --change <id>
spool instructions <artifact> --change <id>
spool templates [--schema <name>]
...
spool status                      # error: missing --change
```
