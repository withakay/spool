...
- \[x\] Verify bash completions work manually: `spool completion install bash && exec bash`
...
- \[x\] Verify fish completions work manually: `spool completion install fish`
...
- \[x\] Run `spool validate extend-shell-completions --strict` and resolve all issues
- \[x\] Update error messages to list all four supported shells
- \[x\] Verify `spool completion --help` documentation is current
