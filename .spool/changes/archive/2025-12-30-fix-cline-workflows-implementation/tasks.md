...
- [x] Change FILE_PATHS in `src/core/configurators/slash/cline.ts` from `.clinerules/spool-*.md` to `.clinerules/workflows/spool-*.md`
...
- [x] Verify the change follows Spool conventions
