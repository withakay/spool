...
2. Validate the produced artifacts on each target.
3. Add/install script and document the recommended installation flow.
4. Cut the first release using the new flow.
