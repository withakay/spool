...
- **THEN** parse and apply delta changes as defined in spool-conventions
- **AND** validate all operations before applying

#### Scenario: Validating delta changes

- **WHEN** processing delta changes
- **THEN** perform validations as specified in spool-conventions
...
- **WHEN** executing `spool archive <change> --skip-specs`
...
- **AND** use standard output symbols (+ ~ - →) as defined in spool-conventions:
  ```
...
- **WHEN** executing `spool archive change-name`
...
- **WHEN** executing `spool archive change-name --no-validate`
