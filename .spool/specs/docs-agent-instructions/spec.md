...
- **WHEN** `spool/AGENTS.md` is regenerated or updated
...
`spool/AGENTS.md` SHALL include complete copy/paste templates and inline examples exactly where agents make corresponding edits.
...
`spool/AGENTS.md` SHALL offer a concise pre-validation checklist that highlights common formatting mistakes before running `spool validate`.
...
- **WHEN** reorganizing `spool/AGENTS.md`
