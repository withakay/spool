# Spool Init Specification

## Purpose

Define the `spool-init` capability: initializing a Spool project by installing harness-specific instructions, skills, commands, and adapters from embedded assets.
