 ...
 * Stores anonymous ID and notice-seen flag in ~/.config/projector/config.json
 */
 ...
 * Uses ~/.config/projector/config.json on all platforms.
 */
export function getConfigPath(): string {
  const configDir = path.join(os.homedir(), '.config', 'projector');
