...
description: Use when creating, designing, planning, proposing, specifying a feature, change, requirement, enhancement, fix, modification, or spec. Use when writing tasks, proposals, or specifications for new work.
---
...
- Next steps: "All artifacts created! Ready to implement with `spool-apply-change-proposal` or request review/iteration"
